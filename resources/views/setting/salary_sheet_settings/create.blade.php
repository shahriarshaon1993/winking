            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>Salary Sheet Setting</h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        {!! Form::open(['route' => ['salary-sheet-settings.store'], 'method' => 'post']) !!}
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="number" name="h_rent" value="{{ $data->h_rent ?? 0 }}" step="any" required class="form-control">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{trans('file.Medical(%)')}} *</label>
                                    <input type="number" name="medical" value="{{ $data->medical ?? 0 }}" step="any" required class="form-control">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{trans('file.T. Port(%)')}} *</label>
                                    <input type="number" name="t_port" value="{{ $data->t_port ?? 0 }}"  step="any" required class="form-control">
                                </div>
                                {{-- <div class="col-md-4 form-group">
