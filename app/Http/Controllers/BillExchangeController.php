...
class BillExchangeController extends Controller
{
    ...
    public function show($id)
    {
        ...
        // dd($bill_exchange);
        $inword = $this->convert_number_to_words($bill_exchange->amount);
        return view('bill_exchange.show', compact('bill_exchange','inword'));
    }
    ...
    public function edit($id)
    {
       ...
       return view('bill_exchange.edit', compact('bankNames','exports','bill','customers'));
    }
